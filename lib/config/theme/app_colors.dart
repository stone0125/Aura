...
class AppColors {
  ...
  static const Color lightPrimaryText = Color(0xFF2C3E50); // Dark gray
  static const Color lightSecondaryText = Color(0xFF7F8C8D); // Medium gray
  ...
  static const Color darkPrimaryText = Color(0xFFE8E8E8); // Off-white
  ...
  static const Color darkRed = Color(0xFFFF5252); // Dark mode delete red
